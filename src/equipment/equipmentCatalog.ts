...
import { stickTypes, migrateStickId } from './stickTypes.ts'
import type {
  EquipmentItem,
  EquipmentShop,
  EquipmentShopId,
...
export const equipmentCatalog: EquipmentItem[] = [
  ...
  createItem({
    ...
    description: 'Light armor that keeps players steady under pressure.',
  }),
  createItem({
    id: 'pocket-plate',
    name: 'Pocket Plate',
    ...
    price: 150,
    statBudget: 3,
    modifiers: { toughness: 3, reaction: 3 },
  ...
  createItem({
    ...
    price: 360,
    statBudget: 8,
    modifiers: { reaction: 8, toughness: 8 },
  ...
  createItem({
    ...
    price: 390,
    statBudget: 9,
    modifiers: { toughness: 9, reaction: 9 },
  ...
  createItem({
    ...
    price: 740,
    statBudget: 13,
    modifiers: { toughness: 13 },
    description: 'Purple armor for bruisers who want to keep possession.',
    perks: [
      equipmentPerks.longCharge,
      equipmentPerks.snapPass,
    ],
  }),
  createItem({
    id: 'apex-runners',
    ...
    price: 820,
    statBudget: 14,
    modifiers: { speed: 14, reaction: 13 },
