...
export function createDefaultLabTuning(): LabTuningState {
  ...
  return {
    ...
    stick: {
      ...
      chargeLoadbackMinRadians: 0.1,
      chargeLoadbackMaxRadians: 0.65,
      chargeLoadbackSmoothing: 12,
      overchargeJitterAmount: 0.04,
      overchargeJitterSpeed: 18,
      releaseWindupMs: 30,
      releaseSwingMs: 90,
      releaseFollowThroughMs: 130,
      releaseSwingArcRadians: 0.85,
      releasePointNormalized: 0.58,
      releaseTangentialForceMultiplier: 0.25,
      releaseForwardForceMultiplier: 0.9,
