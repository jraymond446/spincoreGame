...
export function createDefaultLabTuning(): LabTuningState {
  ...
  return {
    ...
    aiOffense: {
      ...
      opponentAiBankShotFrequency: 0.42,
      opponentAiPassToShotBias: 0.84,
      ...
      aiBankShotPreference: 0.48,
      aiBankShotMinScore: 0.5,
      aiBankShotAttemptChanceWhenBlocked: 0.52,
    ...
    stick: {
      ...
      quickReleasePower: 0.62,
      quickReleaseWindupMs: 35,
      quickReleaseRecoveryMs: 130,
    ...
    defense: {
      ...
      slashArcRadians: 1.4,
      slashRange: 96,
      slashFumblePressure: 0.4,
      slashVsChargingBaseFumble: 0.5,
      slashVsFullChargeBaseFumble: 0.82,
      ...
      fumblePressureDecayPerSecond: 0.1,
      stableFumbleMultiplier: 0.9,
      chargingFumbleMultiplier: 1.75,
      highChargeFumbleMultiplier: 2.35,
      fullChargeFumbleMultiplier: 2.9,
