...
function migrateGameplayDefaults(candidate: unknown): unknown {
  ...
  replaceLegacyDefault(aiTactics, 'passLaneMinScore', 0.38, 0.34)
  replaceLegacyDefault(aiTactics, 'supportPassBias', 0.34, 0.4)
  ...
  replaceLegacyDefault(aiOffense, 'aiCarrierMinCommitMs', 280, 160)
  replaceLegacyDefault(aiOffense, 'aiCarrierMaxCommitMs', 1900, 1200)
  replaceLegacyDefault(aiOffense, 'aiCarrierReevaluateAfterMs', 480, 240)
  replaceLegacyDefault(aiOffense, 'aiMaxCarryMs', 2600, 2200)
  replaceLegacyDefault(aiOffense, 'aiCarrySideCommitMs', 700, 420)
  replaceLegacyDefault(aiOffense, 'aiClearChargeMinMs', 250, 100)
  replaceLegacyDefault(aiOffense, 'aiClearChargeMaxMs', 550, 180)
  replaceLegacyDefault(aiOffense, 'aiPassChargeMinMs', 260, 120)
  replaceLegacyDefault(aiOffense, 'aiPassChargeMaxMs', 520, 220)
  replaceLegacyDefault(aiOffense, 'aiDirectShotChargeMinMs', 760, 160)
  replaceLegacyDefault(aiOffense, 'aiDirectShotChargeMaxMs', 1060, 340)
  replaceLegacyDefault(aiOffense, 'aiBankShotChargeMinMs', 980, 650)
  replaceLegacyDefault(aiOffense, 'aiBankShotChargeMaxMs', 1320, 1050)
  replaceLegacyDefault(aiOffense, 'aiPossessionSettleMs', 300, 180)
  replaceLegacyDefault(aiOffense, 'aiBankShotPreference', 0.45, 0.58)
  replaceLegacyDefault(aiOffense, 'aiShotPatienceMs', 540, 420)
  ...
  replaceLegacyDefault(defense, 'releaseFrameProtectionMs', 70, 60)
