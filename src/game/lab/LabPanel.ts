...
export class LabPanel {
  ...
  private createDefenseSection(): HTMLElement {
    ...
    > = [
      ...
      ['Knockdown threshold', 'truckKnockdownThreshold', { min: -0.3, max: 0.7, step: 0.02, digits: 2 }],
      ['Knockdown ms', 'truckKnockdownMs', { min: 250, max: 1800, step: 25 }],
      ['Get-up ms', 'truckGetUpMs', { min: 180, max: 1200, step: 20 }],
      ['Knockdown immunity ms', 'truckKnockdownImmunityMs', { min: 0, max: 2500, step: 50 }],
      ['Knockdown fumble speed', 'truckKnockdownFumbleSpeed', { min: 1, max: 10, step: 0.2, digits: 1 }],
