  ...
  private resolveArenaVisualSettings(data: PlayerVisualUpdate): {
    ...
    return {
      ...
      proceduralAnimation: {
        ...
        naturalHoldMode: arena.naturalHoldMode,
        legacyCoreMagnetMode: arena.legacyCoreMagnetMode,
        frontArcDegrees: arena.frontArcDegrees,
        sideReachArcDegrees: arena.sideReachArcDegrees,
        readyCarriageAngle: arena.readyCarriageAngle,
        stickBiasStrength: arena.stickBiasStrength,
        stickClampAmount: arena.stickClampAmount,
        ...
        slashAnimationSpeed: arena.slashAnimationSpeed,
